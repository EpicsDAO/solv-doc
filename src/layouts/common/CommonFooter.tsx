...
// import EpicsLogoHorizontalInvert from '@/assets/img/logo/EpicsLogoHorizontalInvert.svg'
            ...
            <div className="py-16">
              ...
              {/* <nav className="mt-12 text-sm" aria-label="quick links">
                <div className="flex flex-col items-center justify-center gap-6 text-center sm:-my-1 sm:flex-row">
                  <a href="https://epics.dev/" target="_blank" rel="noreferrer">
                    <Image
                      src={EpicsLogoHorizontal}
                      alt="Epics DAO"
                      className="w-32 dark:hidden"
                      unoptimized
                    />
                    <Image
                      src={EpicsLogoHorizontalInvert}
                      alt="Epics DAO"
